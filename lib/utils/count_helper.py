...
def comp_multadds(model, input1_size=(2,3,127,127), input2_size=(2,3,255,255), input3_size=(2,4)):
    model = model.cuda()
    z = torch.randn(input1_size).cuda()
    x = torch.randn(input2_size).cuda()
    bbox = torch.randn(input3_size).cuda()
