...
def parse_args():
    ...
    parser.add_argument('--cfg', type=str, default='../experiments/Retrain.yaml', help='yaml configure file name')
...
def main():
    ...
    # model = loader.load_retrain(model, './snapshot/checkpoint_e{}.pth'.format(args.arch_epoch))
