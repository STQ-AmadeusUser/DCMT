...
# init gpu and epochs
comm = MPI.COMM_WORLD
size = comm.Get_size()  # 2080ti/3090 in lab show 1;
rank = comm.Get_rank()  # 2080ti/3090 in lab show 0;
...
for i in range(2):
    ...
    # resume = 'uav_snapshot/checkpoint_e{}.pth'.format(epoch_ID)
    resume = 're_snapshot/checkpoint_e{}.pth'.format(epoch_ID)
